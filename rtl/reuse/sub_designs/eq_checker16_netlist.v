...
module eq_checker16(in1, in2, eq_out);
  ...
  and4$ g1160(.in0 (n_16), .in1 (n_17), .in2 (n_18), .in3 (n_19), .out
       (eq_out));
  and4$ g1161(.in0 (n_11), .in1 (n_0), .in2 (n_6), .in3 (n_8), .out
       (n_19));
  and4$ g1162(.in0 (n_15), .in1 (n_14), .in2 (n_1), .in3 (n_13), .out
       (n_18));
  and4$ g1163(.in0 (n_3), .in1 (n_12), .in2 (n_5), .in3 (n_10), .out
       (n_17));
  and4$ g1164(.in0 (n_2), .in1 (n_4), .in2 (n_7), .in3 (n_9), .out
       (n_16));
